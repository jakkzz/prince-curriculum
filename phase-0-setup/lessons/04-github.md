...
>
> 🇹🇭 *Git อยู่บนเครื่องคุณ — GitHub เอามันขึ้นอินเทอร์เน็ตให้คนอื่นเห็น คนที่จะจ้างในอนาคต เพื่อนร่วมงาน และตัวเองในวันข้างหน้าจะหาเจอที่นี่ GitHub profile **คือ** เรซูเม่ในวงการนี้ วันนี้เริ่มเขียนมัน — 35 สัปดาห์ข้างหน้าจะกลายเป็นกำแพง commit สีเขียว 8 โปรเจกต์ 8 วิดีโอ สิ่งที่เห็นได้นั่นแหละคือรางวัลที่แท้จริง ไม่ใช่แค่ MacBook*
